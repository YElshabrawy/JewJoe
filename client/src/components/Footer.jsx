...
const Footer = () => {
    return (
        <div>
            {/* Divider */}
            <div className="md:border-t md:border-my_gray md:mb-8"></div>
            <div className="md:flex md:items-center md:justify-between">
                {/* Email */}
                <div className="relative mb-9 md:order-2 md:w-1/3">
                    <form>
                        ...
                        <input
                            type="email"
                            id="newsletter"
                            className="w-full border-b-[1.5px] border-black text-gray-900 text-sm pb-2 focus:ring-0"
                            placeholder="Give an email, get the newsletter."
                            required
                        />
                        <button
                            type="submit"
                            className="absolute right-2.5 bottom-2.5 py-2 bg-white"
                        >
                            <svg
                ...
                {/* Links Info */}
                <ul className="block text-my_darkGray space-y-3 mb-5 md:order-1 md:flex md:items-center md:space-y-0 md:space-x-16">
                    <li>
                        <h3>CONTACT</h3>
                    </li>
                    <li>
            ...
            <div className="md:flex md:items-center md:justify-between md:mt-4 md:mb-12">
                {/* Social Icons */}
                <div className="flex items-center space-x-5 mb-5 md:order-2">
                    <a href="/">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="19"
                ...
                {/* Credits */}
                <p className="text-Bs text-my_darkGray md:order-1 md:text-black">
                    © 2020 JewJoe.
                </p>
            </div>
        </div>
